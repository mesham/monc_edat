...
module data_utils_mod
  ...
  use collections_mod, only : map_type, c_get_integer, c_get_string, c_get_generic, c_put_string, c_contains, c_put_integer
  ...
  public is_field_present, get_map, get_map_from_monc, get_scalar_integer, get_scalar_integer_from_monc, get_scalar_logical, &
       ...
       build_depacking_description, check_thread_status
contains
  ...
  subroutine build_depacking_description(data_definition, data_size_info, field_start_locations, &
    ...
    integer :: type_extents(5), type_counts, i, j, field_start, data_type, temp_size, prev_data_type, current_location
    logical :: field_found
  ...
  end subroutine build_depacking_description
